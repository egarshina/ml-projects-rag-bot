...
documents = [
    ...
    "Проект ml-fastapi-docker: демонстрация упаковки обученной CNN-модели (Fashion MNIST) в REST API с помощью FastAPI и Docker. Модель принимает изображение, преобразует его в 28x28 grayscale и возвращает предсказанный класс одежды. Точность на тестовой выборке 91.3%. Есть Dockerfile и инструкция по запуску."
]
